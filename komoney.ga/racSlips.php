...
<div class="racSlips">
    ...
    $slips=$db->prepare("select * from rac where user_id={$_COOKIE['useridKoMoney']} ORDER  BY  targetDate desc");
    $slips->execute();
    $test2="";?>
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success:function(data){
                                                            ...
                                                            if(data=="Closed"){
                                                                ...
                                                                $(".racbalance").text(data.slice(3));
                                                            }else{
                                                                $("#<?php echo $key ?>win").show();
                                                                $(".racbalance").text(data);
                                                            }

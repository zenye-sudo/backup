...
<div class="container-fluid">
    <div class="row">
        ...
        if(!isset($_GET['paidd'])){
            $result=$db->prepare("SELECT * FROM posts WHERE type=$pid LIMIT 0,6");
        }else{
            $result=$db->prepare("SELECT * FROM posts WHERE type=$pid LIMIT $_GET[paidd],7");
        }
        $result->execute();
                    ...
                    <div class="card-header bg-dark">
                        ...
                        <div class="container row">
                            ...
                            <?php if(MySession::checkSession("username")): ?>
                                <div class="col-md-2 bg-info"><a href="filternews.php?pid=<?php echo $_GET['pid'] ?>&lid=<?php echo $item['id'] ?>" class="text-white" ><i class="fa fa-hand-peace"></i>Like <span class="badge bg-danger"> <?php echo $likecount->fetchColumn()?></span></a></div>
                            <?php endif; ?>
                            <?php if(!MySession::checkSession("username")):?>

...
if($fnum1!=""){
    ...
    $array[]=["pp"=>$pp,"tn"=>$total,"username"=>$conservationUserData['username'],"tnUser"=>$retriveTableData['uid'],"tnText"=>substr($retriveTableData['text'],0,25),"tnRowCount"=>$retriveTable->rowCount(),"cal"=>$cal,"conservationCount"=>$cc,"cdf"=>$dd,"nb"=>$str];
}

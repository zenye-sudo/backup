...
require_once "include/filternewssection.php";
?>
<?php
$pid=$_GET['pid'];
$check=$db->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
$result=$db->prepare("SELECT COUNT(id) FROM posts WHERE type=$pid");
$result->execute();
...
<div class="container mb-4 mt-3">
    <ul class="pagination justify-content-center">
        ...
        <?php for($i=0;$i<$count;$i+=6) :?>
            <?php ++$num; ?>
            <li class="page-item"><a href="filternews.php?pid=<?php echo $pid  ?>&paidd=<?php echo $i ?>" class="page-link"><?php echo $num ?></a></li>
        <?php endfor; ?>
